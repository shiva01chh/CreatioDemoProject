(function () {
	...
	GaugeChartHelper.prototype.applyGaugeConfig = function(chartConfig) {
		...
		var maxLabelWidthInPercent = (maxLabelWidth * 2 / this.chart.width) * 100;
		var leftRightPadding = maxLabelWidthInPercent > 50
				? this.chart.width * 0.15
				: this.fontSize + maxLabelWidth;
	...
	GaugeChartHelper.prototype.renderValueLabel = function() {
		var label = `${this.markerFormatFn(this.data.value)}`
		var ctx = this.ctx;
