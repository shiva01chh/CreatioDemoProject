	...
	return {
		"render": function(renderTo) {
			Ext.onReady(function() {
				...
				var comboBox = window.combobox = Ext.create("Terrasoft.MultiLookupEdit", {
					renderTo: renderTo,
					width: "300px",
					minSearchCharsCount: 0,
					markerValue: "testMarker",
					classes: {
						wrapClassName: ["demo-multi-lookup-edit"]
					},
					listViewConfig: {
						map: {
							value: "id",
				...
				var comboBox2 = window.combobox = Ext.create("Terrasoft.MultiLookupEdit", {
					renderTo: renderTo,
					width: "100px",
					minSearchCharsCount: 0,
