define("FileSecurityExcludedUri", ["terrasoft", "ext-base", "FileSecurityExcludedUriResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.FileSecurityExcludedUri", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.FileSecurityExcludedUri",
			singleton: true,
			uId: "8b275e5b-ddac-402c-a984-23aa103544d7",
			name: "FileSecurityExcludedUri",
			caption: resources.localizableStrings.FileSecurityExcludedUriCaption,
		...
		return Terrasoft.FileSecurityExcludedUri;
	});