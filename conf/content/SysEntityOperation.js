define("SysEntityOperation", ["terrasoft", "ext-base", "SysEntityOperationResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysEntityOperation", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysEntityOperation",
			singleton: true,
			uId: "a6af1d7b-0bba-4146-8868-c677c0fb9212",
			name: "SysEntityOperation",
			caption: resources.localizableStrings.SysEntityOperationCaption,
		...
		return Terrasoft.SysEntityOperation;
	});