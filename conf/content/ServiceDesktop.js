Terrasoft.configuration.Structures["ServiceDesktop"] = {innerHierarchyStack: ["ServiceDesktop"], structureParent: "CentralAreaDesktopTemplate"};
define('ServiceDesktopStructure', ['ServiceDesktopResources'], function(resources) {return {schemaUId:'48cac484-a037-41e4-9613-c7c03e8c216e',schemaCaption: "Service Desktop", parentSchemaName: "CentralAreaDesktopTemplate", packageName: "CrtCaseService", schemaName:'ServiceDesktop',parentSchemaUId:'fbc98c89-0691-479c-bc25-59c11ac2365f',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
