define("ConfItemFile", ["terrasoft", "ext-base", "ConfItemFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ConfItemFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ConfItemFile",
			singleton: true,
			uId: "6ac9ea85-b7f1-4687-a7ec-b810d9caefc2",
			name: "ConfItemFile",
			caption: resources.localizableStrings.ConfItemFileCaption,
			...
			columns: {
				...
				ConfItem: {
					uId: "0e2a8e2f-3e7c-4380-a1a6-bad943f18acb",
					name: "ConfItem",
