Terrasoft.configuration.Structures["ProductSelectionSchema"] = {innerHierarchyStack: ["ProductSelectionSchemaProductCatalogue", "ProductSelectionSchema"]};
define('ProductSelectionSchemaProductCatalogueStructure', ['ProductSelectionSchemaProductCatalogueResources'], function(resources) {return {schemaUId:'ac5d3b29-fe62-4b61-a32e-ba01de918eb7',schemaCaption: "Product selection page schema", parentSchemaName: "", packageName: "PRMOrder", schemaName:'ProductSelectionSchemaProductCatalogue',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ProductSelectionSchemaStructure', ['ProductSelectionSchemaResources'], function(resources) {return {schemaUId:'b3204824-0f86-49bf-bf95-8eadf2f6f7de',schemaCaption: "Product selection page schema", parentSchemaName: "ProductSelectionSchemaProductCatalogue", packageName: "PRMOrder", schemaName:'ProductSelectionSchema',parentSchemaUId:'ac5d3b29-fe62-4b61-a32e-ba01de918eb7',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ProductSelectionSchemaProductCatalogue",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ProductSelectionSchemaProductCatalogueResources', ['terrasoft'], function(Terrasoft) {
...
define("ProductSelectionSchemaProductCatalogue", ["ViewGeneratorV2", "ProductManagementDistributionConstants",
