define("ServiceInConfItem", ["terrasoft", "ext-base", "ServiceInConfItemResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ServiceInConfItem", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ServiceInConfItem",
			singleton: true,
			uId: "ef0acf4c-0272-4e3b-9391-e12cf13cec33",
			name: "ServiceInConfItem",
			caption: resources.localizableStrings.ServiceInConfItemCaption,
		...
		return Terrasoft.ServiceInConfItem;
	});