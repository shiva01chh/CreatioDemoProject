...
define('DynamicBlockPropertiesPageStructure', ['DynamicBlockPropertiesPageResources'], function(resources) {return {schemaUId:'5e736bd0-ebbb-48ab-b819-2529fabe2cf7',schemaCaption: "DynamicBlockPropertiesPage", parentSchemaName: "", packageName: "CrtDynamicContent7x", schemaName:'DynamicBlockPropertiesPage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
