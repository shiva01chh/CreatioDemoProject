...
define('SocialChannelPageStructure', ['SocialChannelPageResources'], function(resources) {return {schemaUId:'2d31ccbe-78bf-4875-8698-1f05b6e114f8',schemaCaption: "Channel page", parentSchemaName: "", packageName: "CrtESN7x", schemaName:'SocialChannelPage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
