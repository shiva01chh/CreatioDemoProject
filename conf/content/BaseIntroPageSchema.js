Terrasoft.configuration.Structures["BaseIntroPageSchema"] = {innerHierarchyStack: ["BaseIntroPageSchemaCrtUIv2", "BaseIntroPageSchema"]};
define('BaseIntroPageSchemaCrtUIv2Structure', ['BaseIntroPageSchemaCrtUIv2Resources'], function(resources) {return {schemaUId:'965b3e29-c42b-456f-90e0-8733809d280d',schemaCaption: "Main page base schema", parentSchemaName: "", packageName: "GoogleTagManagerMeasurements", schemaName:'BaseIntroPageSchemaCrtUIv2',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseIntroPageSchemaStructure', ['BaseIntroPageSchemaResources'], function(resources) {return {schemaUId:'4286ddd1-2409-44ea-a299-9a86f882eeba',schemaCaption: "Main page base schema", parentSchemaName: "BaseIntroPageSchemaCrtUIv2", packageName: "GoogleTagManagerMeasurements", schemaName:'BaseIntroPageSchema',parentSchemaUId:'965b3e29-c42b-456f-90e0-8733809d280d',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseIntroPageSchemaCrtUIv2",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseIntroPageSchemaCrtUIv2Resources', ['terrasoft'], function(Terrasoft) {
...
define("BaseIntroPageSchemaCrtUIv2", ["BaseIntroPageSchemaResources", "MainMenuTileGenerator", "AcademyUtilities"],
