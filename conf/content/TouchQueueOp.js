define("TouchQueueOp", ["terrasoft", "ext-base", "TouchQueueOpResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.TouchQueueOp", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.TouchQueueOp",
			singleton: true,
			uId: "b65de3be-f9ee-4013-9012-a02d6648636d",
			name: "TouchQueueOp",
			caption: resources.localizableStrings.TouchQueueOpCaption,
			...
			columns: {
				...
				HashCode: {
					uId: "ab62a7a4-2d7b-fcd0-517b-b4c0d597b26b",
					name: "HashCode",
					caption: resources.localizableStrings.HashCodeCaption,
					dataValueType: Terrasoft.DataValueType.TEXT,
					usageType: 0,
					isInherited: true,
					isValueCloneable: true,
