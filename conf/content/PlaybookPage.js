Terrasoft.configuration.Structures["PlaybookPage"] = {innerHierarchyStack: ["PlaybookPage"], structureParent: "BasePageV2"};
define('PlaybookPageStructure', ['PlaybookPageResources'], function(resources) {return {schemaUId:'f55bff5b-12c1-4290-bd09-d3278bd86a0e',schemaCaption: "Playbook", parentSchemaName: "BasePageV2", packageName: "Playbook", schemaName:'PlaybookPage',parentSchemaUId:'d3cc497c-f286-4f13-99c1-751c468733c0',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
