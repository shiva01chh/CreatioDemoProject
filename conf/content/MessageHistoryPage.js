Terrasoft.configuration.Structures["MessageHistoryPage"] = {innerHierarchyStack: ["MessageHistoryPageMessage", "MessageHistoryPageLocalMessage", "MessageHistoryPage"]};
define('MessageHistoryPageMessageStructure', ['MessageHistoryPageMessageResources'], function(resources) {return {schemaUId:'c15388c5-08a9-4cba-b737-c0cf124426ca',schemaCaption: "Message history page", parentSchemaName: "", packageName: "CrtPortal7x", schemaName:'MessageHistoryPageMessage',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('MessageHistoryPageLocalMessageStructure', ['MessageHistoryPageLocalMessageResources'], function(resources) {return {schemaUId:'05b33741-f158-4366-8597-191fa7f1ee18',schemaCaption: "Message history page", parentSchemaName: "MessageHistoryPageMessage", packageName: "CrtPortal7x", schemaName:'MessageHistoryPageLocalMessage',parentSchemaUId:'c15388c5-08a9-4cba-b737-c0cf124426ca',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"MessageHistoryPageMessage",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('MessageHistoryPageStructure', ['MessageHistoryPageResources'], function(resources) {return {schemaUId:'28758933-e4a2-40f6-bd13-d4d706aefa7b',schemaCaption: "Message history page", parentSchemaName: "", packageName: "CrtPortal7x", schemaName:'MessageHistoryPage',parentSchemaUId:'',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"MessageHistoryPageLocalMessage",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
...
define('MessageHistoryPageLocalMessageResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("MessageHistoryPageLocalMessage", ["LocalMessageConstants", "css!LocalMessageHistoryPageCSS"],
