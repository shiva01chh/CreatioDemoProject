Terrasoft.configuration.Structures["ConfItemComponentDetail"] = {innerHierarchyStack: ["ConfItemComponentDetail"], structureParent: "BaseGridDetailV2"};
define('ConfItemComponentDetailStructure', ['ConfItemComponentDetailResources'], function(resources) {return {schemaUId:'39e70cff-9d4c-4075-bd4c-6cdc240e5a58',schemaCaption: "Detail - Components in configuration items section", parentSchemaName: "BaseGridDetailV2", packageName: "CMDB", schemaName:'ConfItemComponentDetail',parentSchemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
