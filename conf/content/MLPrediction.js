		...
		Ext.define("Terrasoft.data.models.MLPrediction", {
			...
			columns: {
				...
				FeatureContributions: {
					uId: "5e98f787-96e9-4883-896f-4e94f1d8b18f",
					name: "FeatureContributions",
					caption: resources.localizableStrings.FeatureContributionsCaption,
					dataValueType: Terrasoft.DataValueType.TEXT,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
				...
				Bias: {
					uId: "84e52fc1-575a-4f52-bc86-2769b4ff761f",
					name: "Bias",
					caption: resources.localizableStrings.BiasCaption,
					dataValueType: Terrasoft.DataValueType.FLOAT,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
