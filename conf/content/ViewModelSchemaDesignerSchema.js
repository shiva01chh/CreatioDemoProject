Terrasoft.configuration.Structures["ViewModelSchemaDesignerSchema"] = {innerHierarchyStack: ["ViewModelSchemaDesignerSchemaCrtDesignerTools", "ViewModelSchemaDesignerSchema"]};
define('ViewModelSchemaDesignerSchemaCrtDesignerToolsStructure', ['ViewModelSchemaDesignerSchemaCrtDesignerToolsResources'], function(resources) {return {schemaUId:'f6a3d8d0-3407-4b93-9b69-24bb7d4998c1',schemaCaption: "ViewModelSchemaDesignerSchema", parentSchemaName: "", packageName: "Timeline", schemaName:'ViewModelSchemaDesignerSchemaCrtDesignerTools',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ViewModelSchemaDesignerSchemaStructure', ['ViewModelSchemaDesignerSchemaResources'], function(resources) {return {schemaUId:'40a4627d-4374-4928-b27a-5626b1a12a71',schemaCaption: "ViewModelSchemaDesignerSchema", parentSchemaName: "ViewModelSchemaDesignerSchemaCrtDesignerTools", packageName: "Timeline", schemaName:'ViewModelSchemaDesignerSchema',parentSchemaUId:'f6a3d8d0-3407-4b93-9b69-24bb7d4998c1',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ViewModelSchemaDesignerSchemaCrtDesignerTools",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ViewModelSchemaDesignerSchemaCrtDesignerToolsResources', ['terrasoft'], function(Terrasoft) {
...
define("ViewModelSchemaDesignerSchemaCrtDesignerTools", [
	"ColumnHelper",
	"ModalBox",
