...
define('VwDcmLibSectionStructure', ['VwDcmLibSectionResources'], function(resources) {return {schemaUId:'7588c1ac-d562-47ae-a704-7f129f117fc6',schemaCaption: "Base \"Process library\" section page schema", parentSchemaName: "BaseProcessLibSection", packageName: "DcmLibrary", schemaName:'VwDcmLibSection',parentSchemaUId:'994e7d92-df2f-48ef-a38f-c66cac5c44c9',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
