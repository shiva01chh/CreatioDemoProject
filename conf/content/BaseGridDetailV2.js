Terrasoft.configuration.Structures["BaseGridDetailV2"] = {innerHierarchyStack: ["BaseGridDetailV2CrtNUI", "BaseGridDetailV2GoogleTagManagerMeasurements", "BaseGridDetailV2Exchange", "BaseGridDetailV2CTIBase", "BaseGridDetailV2"], structureParent: "BaseDetailV2"};
define('BaseGridDetailV2CrtNUIStructure', ['BaseGridDetailV2CrtNUIResources'], function(resources) {return {schemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseDetailV2", packageName: "SSP", schemaName:'BaseGridDetailV2CrtNUI',parentSchemaUId:'3052ff9d-521d-4a6d-ba92-04a2261e1ea8',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2GoogleTagManagerMeasurementsStructure', ['BaseGridDetailV2GoogleTagManagerMeasurementsResources'], function(resources) {return {schemaUId:'ca7c597b-1f6b-4089-95b0-7991beff6f13',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2CrtNUI", packageName: "SSP", schemaName:'BaseGridDetailV2GoogleTagManagerMeasurements',parentSchemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2CrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2ExchangeStructure', ['BaseGridDetailV2ExchangeResources'], function(resources) {return {schemaUId:'c4d10d1a-9c82-4159-bde1-2c7dcc7d10e5',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2GoogleTagManagerMeasurements", packageName: "SSP", schemaName:'BaseGridDetailV2Exchange',parentSchemaUId:'ca7c597b-1f6b-4089-95b0-7991beff6f13',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2GoogleTagManagerMeasurements",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2CTIBaseStructure', ['BaseGridDetailV2CTIBaseResources'], function(resources) {return {schemaUId:'0a5c1c06-1968-4169-b00a-e28c4f085502',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2Exchange", packageName: "SSP", schemaName:'BaseGridDetailV2CTIBase',parentSchemaUId:'c4d10d1a-9c82-4159-bde1-2c7dcc7d10e5',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2Exchange",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2Structure', ['BaseGridDetailV2Resources'], function(resources) {return {schemaUId:'c0748e93-33dc-4613-8e8e-18e29a7bbab9',schemaCaption: "Base schema - Detail with list", parentSchemaName: "BaseGridDetailV2CTIBase", packageName: "SSP", schemaName:'BaseGridDetailV2',parentSchemaUId:'0a5c1c06-1968-4169-b00a-e28c4f085502',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGridDetailV2CTIBase",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGridDetailV2CrtNUIResources', ['terrasoft'], function(Terrasoft) {
 ...
 */
define("BaseGridDetailV2CrtNUI", ["BaseGridDetailV2Resources", "ConfigurationEnums", "ChangeLogUtilities", "RightUtilities",
