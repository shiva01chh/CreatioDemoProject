Terrasoft.configuration.Structures["ActivitySection"] = {innerHierarchyStack: ["ActivitySectionCrtNUI", "ActivitySection"]};
define('ActivitySectionCrtNUIStructure', ['ActivitySectionCrtNUIResources'], function(resources) {return {schemaUId:'ea6d7c8c-bd1c-4ecf-b595-d1a4ad979edf',schemaCaption: "Activities section (Old version)", parentSchemaName: "", packageName: "Exchange", schemaName:'ActivitySectionCrtNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionStructure', ['ActivitySectionResources'], function(resources) {return {schemaUId:'5c54f4ec-fa7d-418d-9716-9eeea7a7e902',schemaCaption: "Activities section (Old version)", parentSchemaName: "ActivitySectionCrtNUI", packageName: "Exchange", schemaName:'ActivitySection',parentSchemaUId:'ea6d7c8c-bd1c-4ecf-b595-d1a4ad979edf',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ActivitySectionCrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionCrtNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("ActivitySectionCrtNUI", ['ext-base', 'terrasoft', 'sandbox', 'Activity',
	"ActivitySectionCrtNUIStructure", 'ActivitySectionCrtNUIResources', 'ProcessModule',
