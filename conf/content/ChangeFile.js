define("ChangeFile", ["terrasoft", "ext-base", "ChangeFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ChangeFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ChangeFile",
			singleton: true,
			uId: "0c830d94-7d8e-41fe-b151-2f93e873afec",
			name: "ChangeFile",
			caption: resources.localizableStrings.ChangeFileCaption,
			...
			columns: {
				...
				Change: {
					uId: "ad9eea67-64a2-4de5-b903-f1fc5a265e0f",
					name: "Change",
