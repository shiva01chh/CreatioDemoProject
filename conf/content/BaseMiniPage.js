Terrasoft.configuration.Structures["BaseMiniPage"] = {innerHierarchyStack: ["BaseMiniPageCrtNUI", "BaseMiniPageIntegrationV2", "BaseMiniPage"], structureParent: "BaseEntityPage"};
define('BaseMiniPageCrtNUIStructure', ['BaseMiniPageCrtNUIResources'], function(resources) {return {schemaUId:'8e06a577-08e4-424e-bd89-798a34e1b928',schemaCaption: "BaseMiniPage", parentSchemaName: "BaseEntityPage", packageName: "CrtDeduplication", schemaName:'BaseMiniPageCrtNUI',parentSchemaUId:'81c2ebad-7f20-4e71-b0c6-941b1422ba62',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseMiniPageIntegrationV2Structure', ['BaseMiniPageIntegrationV2Resources'], function(resources) {return {schemaUId:'0d0bf936-7e9d-42ed-94d2-fcb5a1ee88c1',schemaCaption: "BaseMiniPage", parentSchemaName: "BaseMiniPageCrtNUI", packageName: "CrtDeduplication", schemaName:'BaseMiniPageIntegrationV2',parentSchemaUId:'8e06a577-08e4-424e-bd89-798a34e1b928',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseMiniPageCrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseMiniPageStructure', ['BaseMiniPageResources'], function(resources) {return {schemaUId:'32ad6b2f-7a42-4822-9096-feb25f9db600',schemaCaption: "BaseMiniPage", parentSchemaName: "BaseMiniPageIntegrationV2", packageName: "CrtDeduplication", schemaName:'BaseMiniPage',parentSchemaUId:'0d0bf936-7e9d-42ed-94d2-fcb5a1ee88c1',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseMiniPageIntegrationV2",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseMiniPageCrtNUIResources', ['terrasoft'], function(Terrasoft) {
 ...
 */
define("BaseMiniPageCrtNUI", ["BaseMiniPageResources", "sandbox", "NetworkUtilities", "RightUtilities",
...
define('BaseMiniPageIntegrationV2Resources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseMiniPageIntegrationV2", [],
	function() {
		return {
			messages: {
				"EntityInitialized": {
