Terrasoft.configuration.Structures["BaseWidgetDesigner"] = {innerHierarchyStack: ["BaseWidgetDesignerCrtPlatform7x", "BaseWidgetDesigner"], structureParent: "BaseWidgetPreviewDesigner"};
define('BaseWidgetDesignerCrtPlatform7xStructure', ['BaseWidgetDesignerCrtPlatform7xResources'], function(resources) {return {schemaUId:'8c9456fa-46da-4100-94f9-8653274ab717',schemaCaption: "Base widgets designer", parentSchemaName: "BaseWidgetPreviewDesigner", packageName: "CrtDesignerTools", schemaName:'BaseWidgetDesignerCrtPlatform7x',parentSchemaUId:'cbe89c2d-78ba-4edf-9293-f13e4de50fea',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseWidgetDesignerStructure', ['BaseWidgetDesignerResources'], function(resources) {return {schemaUId:'2187c60f-14e7-422f-9591-1713ce4d4d20',schemaCaption: "Base widgets designer", parentSchemaName: "BaseWidgetDesignerCrtPlatform7x", packageName: "CrtDesignerTools", schemaName:'BaseWidgetDesigner',parentSchemaUId:'8c9456fa-46da-4100-94f9-8653274ab717',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseWidgetDesignerCrtPlatform7x",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseWidgetDesignerCrtPlatform7xResources', ['terrasoft'], function(Terrasoft) {
...
define("BaseWidgetDesignerCrtPlatform7x", ["terrasoft", "ColumnEditMixin",
