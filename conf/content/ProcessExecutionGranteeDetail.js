Terrasoft.configuration.Structures["ProcessExecutionGranteeDetail"] = {innerHierarchyStack: ["ProcessExecutionGranteeDetail"], structureParent: "BaseOperationGranteeDetail"};
define('ProcessExecutionGranteeDetailStructure', ['ProcessExecutionGranteeDetailResources'], function(resources) {return {schemaUId:'c9bdacff-b131-94ec-ab1c-d63abd8f1f95',schemaCaption: "Section list detail schema - \"Process execution permissions\"", parentSchemaName: "BaseOperationGranteeDetail", packageName: "ProcessLibrary", schemaName:'ProcessExecutionGranteeDetail',parentSchemaUId:'73d9ee7a-04b8-c99f-2eef-12bcad253125',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
