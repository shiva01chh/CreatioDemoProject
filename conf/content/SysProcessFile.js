define("SysProcessFile", ["terrasoft", "ext-base", "SysProcessFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysProcessFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysProcessFile",
			singleton: true,
			uId: "19acfe2d-92f9-9d4a-b4b5-58f387e3091b",
			name: "SysProcessFile",
			caption: resources.localizableStrings.SysProcessFileCaption,
			...
			columns: {
				...
				SysProcess: {
					uId: "2dcabb6f-fa06-2ed4-063e-89b5c6cbd22d",
					name: "SysProcess",
		...
		return Terrasoft.SysProcessFile;
	});