define("TotpSetupTokenResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		TotpSetupTokenCaption: "TotpSetupToken",
		IdCaption: "Id",
		...
		TokenValueCaption: "TokenValue",
		SecretValueCaption: "SecretValue"
	};
