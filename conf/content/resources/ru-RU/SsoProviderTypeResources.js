define("SsoProviderTypeResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		SsoProviderTypeCaption: "SsoProviderType",
		IdCaption: "Id",
		...
		StartSsoClientProviderCaption: "StartSsoClientProvider"
	};
