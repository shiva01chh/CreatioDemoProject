define("MLSequencePredictionModelPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		SequencePredictionRootSchemaHint: "Entity that contains sequence items",
		SequencePredictionRootSchemaCaption: "Entity with sequences",
	...
	var localizableImages = {
		TagButtonIcon: {
			source: 3,
			params: {
				schemaName: "MLSequencePredictionModelPage",
