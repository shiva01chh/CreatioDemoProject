define("CampaignStartLandingPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		LandingEntitySchemaNameCaption: "Object",
		IsRecurringLabel: "Participation rules",
		IsRecurringCaption: "Recurring entrance",
		IsRecurringHint: "Property defines participation rules, in case of recurring entrance.\nIf checked - previous participants will be suspended.\nIf not - flow will be executed till element with delay.",
		...
		ProcessInformationText: "Contacts that register from a landing page are instantly included in the campaign regardless of the campaign execution frequency. The campaign data will be enriched with the landing page data. \u003Ca href=\u0022{0}\u0022 data-context-help-code=\u0022CampaignStartLandingElement\u0022 target=\u0022_blank\u0022\u003ELearn more\u003C/a\u003E\n",
	...
	var localizableImages = {
		CloseButtonImage: {
			source: 3,
			params: {
				schemaName: "CampaignStartLandingPage",
