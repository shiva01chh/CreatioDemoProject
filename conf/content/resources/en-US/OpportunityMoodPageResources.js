define("OpportunityMoodPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		PercentMustBeUnique: "The entered value is already in use. Please enter another percent value.",
	...
	var localizableImages = {
		BackButtonImage: {
			source: 3,
			params: {
				schemaName: "OpportunityMoodPage",
