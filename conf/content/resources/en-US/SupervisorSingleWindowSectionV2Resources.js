define("SupervisorSingleWindowSectionV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		FillQueueCaption: "Fill queue",
		QueuesUpdateProcessStarted: "Queue update process started.",
		QueuesUpdateProcessAlreadyStarted: "Queue update process was not started because it had started before."
	};
