define("WebServiceV2SectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		AddRestCaption: "REST service",
		AddSoapCaption: "SOAP service",
		SoapWizardCaption: "SOAP web service quick setup",
		WsdlUploadButtonCaption: "Select file",
		WsdlFilePromptCaption: "Select WSDL file",
		SkipWizardButtonCaption: "Skip quick setup",
		WsdlParsingError: "Incorrect file format or WSDL data. Please select another file and try again.",
		WizardSave: "Save",
		WizardNext: "Next",
		WizardBack: "Back",
		SelectSoapService: "Select which SOAP service and version to use:",
		SoapWizardServiceSelectedCaption: "##service-caption## SOAP service setup",
		WizardActionCaption: "Select methods to call from Creatio and their request parameters:",
		WizardResponseActionCaption: "Select response parameters:",
		WizardResponseParametersCaption: "Response parameter",
		WizardRequestParametersCaption: "Request parameter",
		WizardMethodCaption: "Method",
		SchemaDocumentFileNotFoundError: "Cannot find file \u0022{0}\u0022. Please check your set of files and try again.",
		WsdlFileAndUrlPromptCaption: "Insert link to WSDL, or upload WSDL and XSD files",
		WsdlLinkPlaceholderText: "Insert link to WSDL",
		DownloadXmlSchemaError: "Incorrect file format or WSDL data. Please check the link and try again.",
