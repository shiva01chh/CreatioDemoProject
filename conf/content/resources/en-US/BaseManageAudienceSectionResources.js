define("BaseManageAudienceSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		SectionCaption: "Manage audience: {0}",
		RemoveAudienceButtonCaption: "Delete",
		RemoveSelectedMenuItemCaption: "Delete selected",
		RemoveByFilterMenuItemCaption: "Delete by filter",
		SelectedRecordsLimitReachedMessage: "More than {0} records selected. Please specify filter settings or download all filtered records using \u0022Delete by filter\u0022 action in delete audience menu bar.",
		OnRemoveSelectedRecordsMessage: "Are you sure you want to delete the selected items from bulk email audience?",
		OnRemoveByFilterMessage: "Are you sure you want to delete the filtered items from bulk email audience?",
		DuplicateTypeDefault: "All",
		DuplicateTypeEmail: "Email duplicates",
		DuplicateTypeContact: "Contact duplicates",
		...
		OnProcessAudienceFailedMessage: "An error occurred while processing the audience",
