define("MLRecommendationModelPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		CFInteractionValueColumnHint: "Select a numeric column in the section, detail or lookup specified in the [Recommendation dependency] field. This column will be used to grade the \u201Cquality\u201D of dependency between the recommendation subject and the recommended object. For example, the number of products ordered by a contact is a quality of dependency between the corresponding contact and different products. \u003Ca href=\u0022http://academy.creatio.com/documents/?product=administration\u0026ver=8\u0026id=2077\u0022 target=\u0022_blank\u0022\u003ERead more...\u003C/a\u003E",
		...
		CFResultGroupCaption: "Setting up saving prediction results",
		CFResultItemCaption: "Recommended object",
		CFResultModelCaption: "ML  model",
		CFResultSchemaCaption: "Object",
		CFResultTimestampCaption: "Prediction date",
		CFResultUserCaption: "Recommended to (Subject)",
		CFResultValueCaption: "Probability",
		CFRootSchemaCaption: "Recommendation dependency",
		CFRootSchemaHint: "An AI-based recommendation considers the dependency between the recommendation entities: the subject and the recommended item. Select a section, detail or lookup that establishes connection between the \u201Csubject\u201D (the entity that receives recommendation) and the recommended item. \u003Ca href=\u0022http://academy.creatio.com/documents/?product=administration\u0026ver=8\u0026id=2077\u0022 target=\u0022_blank\u0022\u003ERead more...\u003C/a\u003E",
	...
	var localizableImages = {
		AddColumnMenuIcon: {
			source: 3,
			params: {
				schemaName: "MLRecommendationModelPage",
