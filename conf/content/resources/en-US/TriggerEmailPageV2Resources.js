define("TriggerEmailPageV2Resources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		StopSendingConfirmationMessage: "The trigger email will be stopped without an option to restart. Emails to the recipients not yet passed to the email provider will be canceled with the \u201CStopped (manually)\u201D response. Note that campaign participants will not be added to the stopped bulk email. Edit the campaign diagram to ensure the intended behavior.",
