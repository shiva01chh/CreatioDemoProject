define("WordPrintableTablePartPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ParametersTabCaption: "Table parameters",
		FiltersTabCaption: "Table filters",
		CaptionLabel: "Table name",
		TableObjectLabel: "Table object",
		MainObjectColumnLabel: "Column of the primary report object",
		TableObjectColumnLabel: "\u0421olumn of report table object",
		IsEmptyTableHideLabel: "Hide the table if it contains no data",
		TableObjectTip: "System object whose data will display in the table",
		MainObjectColumnTip: "A column of the primary report object that links it to the table. The value in this column will be used to filter the report table data",
		TableObjectColumnTip: "A column of report table object that links table records to the report. The table data will be filtered by this column of the report table object",
		CaptionTip: "Table name, that will be shown in the MS Word plugin",
		FilterModulePlaceHolderLabel: "Select table object to display filter settings",
		TableObjectMacrosEditorCaption: "Set up table columns",
		TableObjectMacrosEditorInfoButtonText: "Select the columns to use for generating the report tables. You can sort table records in ascending or descending order. More information is available on Creatio Academy",
		MacrosModulePlaceHolderLabel: "Select table object to display table parameters",
		DefaultPageHeaderCaption: "New record",
		CopyPostfixCaption: "Copy",
