define("ITILServiceTransitionsIntroPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		ServicePactSectionCaption: "Service agreement"
	};
	...
	var localizableImages = {
		BasisIcon: {
			source: 3,
			params: {
				schemaName: "ITILServiceTransitionsIntroPage",
