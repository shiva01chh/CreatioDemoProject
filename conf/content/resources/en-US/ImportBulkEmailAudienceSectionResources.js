define("ImportBulkEmailAudienceSectionResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		ImportAudienceButtonCaption: "Import",
		ImportByFilterMenuItemCaption: "Import by filter",
		ImportSelectedMenuItemCaption: "Import selected",
		...
		OnImportByFilterMessage: "Would you like to import all filtered records? \nImport process runs in background. A message about its completion will appear in the notification area.",
		OnImportSelectedRecordsMessage: "Would you like to import {0} record(-s)? \nImport process runs in background. A message about its completion will appear in the notification area.",
		...
		ScrollTopCaption: "Up",
		SectionCaption: "Import audience: {0}",
		SectionQuickFilterButtonCaption: "Quick filter",
		SelectAllButtonCaption: "Select all",
		SelectedFolderButtonCaption: "Folders",
		SelectedRecordsLimitReachedMessage: "More than {0} records selected. Please specify filter settings or download all filtered records using \u0022Import by filter\u0022 action in import menu bar.",
