define("ServiceEnterpriseIntroPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		ProblemSectionCaption: "Problems",
		ConfItemSectionCaption: "Configuration items",
		ChangeSectionCaption: "Changes",
		ReleaseSectionCaption: "Releases",
		ServicePactSectionCaption: "Service agreements",
		QueueSectionCaption: "Queues",
		OperatorSingleWindowSectionCaption: "Agent desktop"
	};
	...
	var localizableImages = {
		BasisIcon: {
			source: 3,
			params: {
				schemaName: "ServiceEnterpriseIntroPage",
