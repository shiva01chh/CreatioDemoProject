define("ProcessFileProcessingUserTaskPropertiesPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		...
		ChangeSourceActionTypeWarningMessage: "Are you sure you want to change the source? All field values will be lost.",
	...
	var localizableImages = {
		CloseButtonImage: {
			source: 3,
			params: {
				schemaName: "ProcessFileProcessingUserTaskPropertiesPage",
