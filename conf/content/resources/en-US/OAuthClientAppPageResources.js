define("OAuthClientAppPageResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		ClientSecretCaption: "Client secret",
		IsActiveTip: "Turns OAuth 2.0 authorized access on/off",
		SystemUserTip: "The user on whose behalf the connected app will act",
		ClientIdSecretTip: "OAuth 2.0 credential to use in the connected app",
		InvalidUrlFormat: "URL is invalid",
		GeneralInfoGroupCaption: "Basic information",
		SecurityInfoGroupCaption: "OAuth client credentials",
		ApplicationUrlTip: "The full URL to your application homepage",
		RedirectUrlTip: "The redirection URI used to deliver the access token to the client",
