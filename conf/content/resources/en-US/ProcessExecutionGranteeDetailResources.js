define("ProcessExecutionGranteeDetailResources", ["terrasoft"], function(Terrasoft) {
	var localizableStrings = {
		LaunchRightsInfoTip: "\u2022 These permissions only affect business processes that are run manually.\n\n\u2022 These permissions only affect users without \u0022Can run all business processes\u0022 system operation permission.",
		ActionsButtonCaption: "Actions",
		AddButtonCaption: "New",
		Caption: "Permissions to run",
