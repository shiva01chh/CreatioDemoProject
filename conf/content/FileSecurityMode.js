define("FileSecurityMode", ["terrasoft", "ext-base", "FileSecurityModeResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.FileSecurityMode", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.FileSecurityMode",
			singleton: true,
			uId: "cd7ee836-7650-4817-804c-560f86b21d29",
			name: "FileSecurityMode",
			caption: resources.localizableStrings.FileSecurityModeCaption,
		...
		return Terrasoft.FileSecurityMode;
	});