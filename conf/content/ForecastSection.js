...
define('ForecastSectionStructure', ['ForecastSectionResources'], function(resources) {return {schemaUId:'6c3d9af8-dc7b-4ce9-af02-116d88a947a1',schemaCaption: "ForecastSection", parentSchemaName: "", packageName: "CoreForecast", schemaName:'ForecastSection',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
