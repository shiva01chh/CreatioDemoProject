define("BaseTaskQueue", ["terrasoft", "ext-base", "BaseTaskQueueResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BaseTaskQueue", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BaseTaskQueue",
			singleton: true,
			uId: "de97f161-117b-49b0-b08a-38ae2a77cdd1",
			name: "BaseTaskQueue",
			caption: resources.localizableStrings.BaseTaskQueueCaption,
		...
		return Terrasoft.BaseTaskQueue;
	});