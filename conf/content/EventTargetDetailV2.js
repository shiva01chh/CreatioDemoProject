Terrasoft.configuration.Structures["EventTargetDetailV2"] = {innerHierarchyStack: ["EventTargetDetailV2"], structureParent: "BaseAudienceDetail"};
define('EventTargetDetailV2Structure', ['EventTargetDetailV2Resources'], function(resources) {return {schemaUId:'5829b2e1-867c-409d-9553-a3346e1e058e',schemaCaption: "Event target audience - Detail", parentSchemaName: "BaseAudienceDetail", packageName: "MarketingCampaign", schemaName:'EventTargetDetailV2',parentSchemaUId:'cfd33079-1671-cf81-3fa5-cdc20dc9afa8',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
