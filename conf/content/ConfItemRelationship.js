define("ConfItemRelationship", ["terrasoft", "ext-base", "ConfItemRelationshipResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ConfItemRelationship", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ConfItemRelationship",
			singleton: true,
			uId: "8857f5ff-b876-481c-9c05-7d93c08f7704",
			name: "ConfItemRelationship",
			caption: resources.localizableStrings.ConfItemRelationshipCaption,
		...
		return Terrasoft.ConfItemRelationship;
	});