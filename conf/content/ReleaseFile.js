define("ReleaseFile", ["terrasoft", "ext-base", "ReleaseFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ReleaseFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ReleaseFile",
			singleton: true,
			uId: "59949191-fd3c-407d-a73a-26b6bcb6f655",
			name: "ReleaseFile",
			caption: resources.localizableStrings.ReleaseFileCaption,
			...
			columns: {
				...
				Release: {
					uId: "69aeaa38-2be0-489c-a46c-da2a5c6b4dd1",
					name: "Release",
