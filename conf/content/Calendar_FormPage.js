Terrasoft.configuration.Structures["Calendar_FormPage"] = {innerHierarchyStack: ["Calendar_FormPage"], structureParent: "ListFreedomTemplate"};
define('Calendar_FormPageStructure', ['Calendar_FormPageResources'], function(resources) {return {schemaUId:'290cbcb0-d18d-475d-8a37-75e30216497b',schemaCaption: "Calendar form page", parentSchemaName: "ListFreedomTemplate", packageName: "CrtProductivityApp", schemaName:'Calendar_FormPage',parentSchemaUId:'3f1f3f38-a0a4-4549-b895-249fb08f554a',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){

}};});
define("Calendar_FormPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"caption": "#ResourceString(MenuItem_ExportToExel2_caption)#"
				}
			},
			{
				"operation": "merge",
