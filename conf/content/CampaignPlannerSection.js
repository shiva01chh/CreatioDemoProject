...
define('CampaignPlannerSectionStructure', ['CampaignPlannerSectionResources'], function(resources) {return {schemaUId:'7a779ebe-219c-44ef-a599-8972e6bfd5fe',schemaCaption: "CampaignPlannerSection", parentSchemaName: "BaseMarketingCalendarSection", packageName: "CampaignPlannerNew", schemaName:'CampaignPlannerSection',parentSchemaUId:'739873f7-d055-4a3e-8962-c7d2d7f6394a',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
