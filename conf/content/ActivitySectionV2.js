Terrasoft.configuration.Structures["ActivitySectionV2"] = {innerHierarchyStack: ["ActivitySectionV2CrtNUI", "ActivitySectionV2Exchange", "ActivitySectionV2"], structureParent: "BaseSectionV2"};
define('ActivitySectionV2CrtNUIStructure', ['ActivitySectionV2CrtNUIResources'], function(resources) {return {schemaUId:'569aaf1a-5943-4f87-ab47-948d941e4920',schemaCaption: "Activities section", parentSchemaName: "BaseSectionV2", packageName: "IntegrationV2", schemaName:'ActivitySectionV2CrtNUI',parentSchemaUId:'7912fb69-4fee-429f-8b23-93943c35d66d',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionV2ExchangeStructure', ['ActivitySectionV2ExchangeResources'], function(resources) {return {schemaUId:'2c887791-3cc6-4db4-b1b1-eba4aa7cf1ea',schemaCaption: "Activities section", parentSchemaName: "ActivitySectionV2CrtNUI", packageName: "IntegrationV2", schemaName:'ActivitySectionV2Exchange',parentSchemaUId:'569aaf1a-5943-4f87-ab47-948d941e4920',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ActivitySectionV2CrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionV2Structure', ['ActivitySectionV2Resources'], function(resources) {return {schemaUId:'431ab13c-e352-5095-0699-a93ababfaf36',schemaCaption: "Activities section", parentSchemaName: "ActivitySectionV2Exchange", packageName: "IntegrationV2", schemaName:'ActivitySectionV2',parentSchemaUId:'2c887791-3cc6-4db4-b1b1-eba4aa7cf1ea',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ActivitySectionV2Exchange",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ActivitySectionV2CrtNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("ActivitySectionV2CrtNUI", ["BaseFiltersGenerateModule", "ConfigurationConstants", "ConfigurationEnums",
...
define('ActivitySectionV2ExchangeResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("ActivitySectionV2Exchange", ["ExchangeNUIConstants", "ConfigurationConstants", "SyncSettingsMixin"],
