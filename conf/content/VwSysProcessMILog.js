define("VwSysProcessMILog", ["terrasoft", "ext-base", "VwSysProcessMILogResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwSysProcessMILog", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwSysProcessMILog",
			singleton: true,
			uId: "7ad8a1a3-1c8b-44b3-8a1d-f9bac60fb56e",
			name: "VwSysProcessMILog",
			caption: resources.localizableStrings.VwSysProcessMILogCaption,
			...
			columns: {
				...
				Parent: {
					...
					isSensitiveData: false,
					isLookup: true,
					referenceSchemaName: "VwSysProcessMILog",
					referenceSchema: {
						name: "VwSysProcessMILog",
						primaryColumnName: "Id",
						primaryDisplayColumnName: "Name"
				...
				IteratorElement: {
					uId: "d6c888e9-0010-49a2-ad85-3b7871521aec",
					name: "IteratorElement",
					caption: resources.localizableStrings.IteratorElementCaption,
					dataValueType: Terrasoft.DataValueType.LOOKUP,
					usageType: 2,
					isInherited: false,
					isValueCloneable: true,
					isSensitiveData: false,
					isLookup: true,
					referenceSchemaName: "SysPrcSchemaElement",
					referenceSchema: {
				...
				IterationNumber: {
					uId: "9f30408a-2321-4c1c-aa3f-ac7ce58088c9",
					name: "IterationNumber",
					caption: resources.localizableStrings.IterationNumberCaption,
					dataValueType: Terrasoft.DataValueType.INTEGER,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
		...
		return Terrasoft.VwSysProcessMILog;
	});