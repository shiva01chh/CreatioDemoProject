define("OmnichannelMessageFile", ["terrasoft", "ext-base", "OmnichannelMessageFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.OmnichannelMessageFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.OmnichannelMessageFile",
			singleton: true,
			uId: "e6b4c4d4-0a51-4a6d-a8c5-18b63faddad4",
			name: "OmnichannelMessageFile",
			caption: resources.localizableStrings.OmnichannelMessageFileCaption,
			...
			columns: {
				...
				MessageId: {
					uId: "92c2d485-230a-4174-8651-a96936fc47cc",
					name: "MessageId",
		...
		return Terrasoft.OmnichannelMessageFile;
	});