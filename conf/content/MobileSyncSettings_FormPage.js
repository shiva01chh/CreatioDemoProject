Terrasoft.configuration.Structures["MobileSyncSettings_FormPage"] = {innerHierarchyStack: ["MobileSyncSettings_FormPage"], structureParent: "PageWithLeftAreaTemplate"};
define('MobileSyncSettings_FormPageStructure', ['MobileSyncSettings_FormPageResources'], function(resources) {return {schemaUId:'d069d081-33ce-4ace-8e8a-7cfcb93c5e83',schemaCaption: "MobileSyncSettings form page", parentSchemaName: "PageWithLeftAreaTemplate", packageName: "MobileDesigner", schemaName:'MobileSyncSettings_FormPage',parentSchemaUId:'0f8eb896-7b62-4dfa-bd55-a414f50932a7',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
