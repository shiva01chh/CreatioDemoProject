Terrasoft.configuration.Structures["KnowledgeBasePage"] = {innerHierarchyStack: ["KnowledgeBasePageCrtNUI", "KnowledgeBasePage", "KnowledgeBasePage"]};
define('KnowledgeBasePageCrtNUIStructure', function() {return {type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){}};});
define('KnowledgeBasePageStructure', ['KnowledgeBasePageResources'], function(resources) {return {schemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',schemaCaption: "Page - Knowledge base", parentSchemaName: "KnowledgeBasePageCrtNUI", packageName: "KnowledgeBase", schemaName:'KnowledgeBasePage',parentSchemaUId:'49167555-fc46-4762-87a5-a1b7830f8457',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"KnowledgeBasePageCrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('KnowledgeBasePageStructure', ['KnowledgeBasePageResources'], function(resources) {return {schemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',schemaCaption: "Page - Knowledge base", parentSchemaName: "KnowledgeBasePage", packageName: "KnowledgeBase", schemaName:'KnowledgeBasePage',parentSchemaUId:'e9a4349f-bd96-41e0-b23c-3ffb6eb05ed1',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"KnowledgeBasePage",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('KnowledgeBasePageCrtNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("KnowledgeBasePageCrtNUI", ['ext-base', 'terrasoft', 'sandbox', 'KnowledgeBase', "KnowledgeBasePageCrtNUIStructure",
	'KnowledgeBasePageCrtNUIResources', 'GeneralDetails', 'ConfigurationEnums', 'KnowledgeBaseTag',
