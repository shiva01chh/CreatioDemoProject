define("VwBulkEmailTarget", ["terrasoft", "ext-base", "VwBulkEmailTargetResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.VwBulkEmailTarget", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.VwBulkEmailTarget",
			singleton: true,
			uId: "46217089-79d1-4b82-b167-6d2dcd287eee",
			name: "VwBulkEmailTarget",
			caption: resources.localizableStrings.VwBulkEmailTargetCaption,
			...
			columns: {
				...
				Replica: {
					uId: "ef263e41-910f-48d5-8742-0aa2f3dad577",
					name: "Replica",
		...
		return Terrasoft.VwBulkEmailTarget;
	});