Terrasoft.configuration.Structures["ContactCenterHomePage"] = {innerHierarchyStack: ["ContactCenterHomePage"], structureParent: "BaseHomePage"};
define('ContactCenterHomePageStructure', ['ContactCenterHomePageResources'], function(resources) {return {schemaUId:'e793d043-40fd-4b4a-a387-d26b92c408b4',schemaCaption: "Agent homepage", parentSchemaName: "BaseHomePage", packageName: "ServiceDefSettings", schemaName:'ContactCenterHomePage',parentSchemaUId:'0c5cfb7a-1ed9-41b8-905e-9a38c6915550',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
