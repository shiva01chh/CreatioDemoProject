...
define('ProcessVersionsDetailStructure', ['ProcessVersionsDetailResources'], function(resources) {return {schemaUId:'d7b6b0ae-2b7e-43d3-845b-d8eebaaf9f14',schemaCaption: "Process versions detail schema", parentSchemaName: "BaseGridDetailV2", packageName: "ProcessLibrary", schemaName:'ProcessVersionsDetail',parentSchemaUId:'01eb38ee-668a-42f0-999d-c2534f979089',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
