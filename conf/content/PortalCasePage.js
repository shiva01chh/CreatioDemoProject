Terrasoft.configuration.Structures["PortalCasePage"] = {innerHierarchyStack: ["PortalCasePageCrtPortal7x", "PortalCasePagePortalCustomerService", "PortalCasePage"], structureParent: "BaseModulePageV2"};
define('PortalCasePageCrtPortal7xStructure', ['PortalCasePageCrtPortal7xResources'], function(resources) {return {schemaUId:'b5f26c3c-a60f-4218-8bb8-b1e38a1071e2',schemaCaption: "Edit page schema - \"Cases\" section on Portal", parentSchemaName: "BaseModulePageV2", packageName: "PortalITILService", schemaName:'PortalCasePageCrtPortal7x',parentSchemaUId:'d62293c0-7f14-44b1-b547-735fb40499cd',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('PortalCasePagePortalCustomerServiceStructure', ['PortalCasePagePortalCustomerServiceResources'], function(resources) {return {schemaUId:'62b49448-dbb9-468c-9223-7fee32834ee5',schemaCaption: "Edit page schema - \"Cases\" section on Portal", parentSchemaName: "PortalCasePageCrtPortal7x", packageName: "PortalITILService", schemaName:'PortalCasePagePortalCustomerService',parentSchemaUId:'b5f26c3c-a60f-4218-8bb8-b1e38a1071e2',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"PortalCasePageCrtPortal7x",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('PortalCasePageStructure', ['PortalCasePageResources'], function(resources) {return {schemaUId:'1d66ab43-d898-4e4b-9c19-26fa6c067e31',schemaCaption: "Edit page schema - \"Cases\" section on Portal", parentSchemaName: "PortalCasePagePortalCustomerService", packageName: "PortalITILService", schemaName:'PortalCasePage',parentSchemaUId:'62b49448-dbb9-468c-9223-7fee32834ee5',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"PortalCasePagePortalCustomerService",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('PortalCasePageCrtPortal7xResources', ['terrasoft'], function(Terrasoft) {
...
define("PortalCasePageCrtPortal7x", [
...
define('PortalCasePagePortalCustomerServiceResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("PortalCasePagePortalCustomerService", [], function() {
	return {
		entitySchemaName: "Case",
		details: /**SCHEMA_DETAILS*/{}/**SCHEMA_DETAILS*/,
