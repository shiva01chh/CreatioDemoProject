Terrasoft.configuration.Structures["LandingiDesigner_Page"] = {innerHierarchyStack: ["LandingiDesigner_Page"], structureParent: "PageWithTabsFreedomTemplate"};
define('LandingiDesigner_PageStructure', ['LandingiDesigner_PageResources'], function(resources) {return {schemaUId:'1becc3b3-6ae3-49b8-9f8a-a84776257bd4',schemaCaption: "Web forms and pages", parentSchemaName: "PageWithTabsFreedomTemplate", packageName: "LandingiIntegration", schemaName:'LandingiDesigner_Page',parentSchemaUId:'3b2e117f-8c6b-4ca5-80a2-7ebb497cddf9',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
