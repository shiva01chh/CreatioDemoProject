Terrasoft.configuration.Structures["ProductInOrder_MiniPage"] = {innerHierarchyStack: ["ProductInOrder_MiniPage"], structureParent: "BaseMiniPageTemplate"};
define('ProductInOrder_MiniPageStructure', ['ProductInOrder_MiniPageResources'], function(resources) {return {schemaUId:'5f13728b-ef06-4948-90c9-05367ef9e6f9',schemaCaption: "Product in order modal page", parentSchemaName: "BaseMiniPageTemplate", packageName: "CrtOrder", schemaName:'ProductInOrder_MiniPage',parentSchemaUId:'ecdcc8ff-272c-4957-9381-7d74ce17e140',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
