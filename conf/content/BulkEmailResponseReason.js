define("BulkEmailResponseReason", ["terrasoft", "ext-base", "BulkEmailResponseReasonResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BulkEmailResponseReason", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BulkEmailResponseReason",
			singleton: true,
			uId: "88d071ae-5126-4004-aa4e-c2b9af022640",
			name: "BulkEmailResponseReason",
			caption: resources.localizableStrings.BulkEmailResponseReasonCaption,
			...
			columns: {
				...
				CountToSetIsNonActualEmail: {
					uId: "5a0b3f9a-9009-5104-9927-1d4fece7345d",
					name: "CountToSetIsNonActualEmail",
					caption: resources.localizableStrings.CountToSetIsNonActualEmailCaption,
					dataValueType: Terrasoft.DataValueType.INTEGER,
					usageType: 0,
					isInherited: false,
					isValueCloneable: true,
		...
		return Terrasoft.BulkEmailResponseReason;
	});