Terrasoft.configuration.Structures["CustomIdpSettingsForm"] = {innerHierarchyStack: ["CustomIdpSettingsForm"], structureParent: "PageWithAreaTemplate"};
define('CustomIdpSettingsFormStructure', ['CustomIdpSettingsFormResources'], function(resources) {return {schemaUId:'11d18d1c-1788-40c7-81d4-7d700d10c0be',schemaCaption: "Custom IDP settings form", parentSchemaName: "PageWithAreaTemplate", packageName: "SsoSettings", schemaName:'CustomIdpSettingsForm',parentSchemaUId:'e4b45c7b-cfe3-4ee4-b56b-502f690db0d5',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
