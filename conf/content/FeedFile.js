define("FeedFile", ["terrasoft", "ext-base", "FeedFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.FeedFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.FeedFile",
			singleton: true,
			uId: "45492972-212b-4785-b5fc-fc5769c15cf9",
			name: "FeedFile",
			caption: resources.localizableStrings.FeedFileCaption,
			...
			columns: {
				...
				RecordSchemaName: {
					uId: "789fa023-8511-adc3-cb3d-4c1e67c6db5a",
					name: "RecordSchemaName",
					caption: resources.localizableStrings.RecordSchemaNameCaption,
					dataValueType: Terrasoft.DataValueType.TEXT,
					usageType: 0,
					isInherited: true,
					isValueCloneable: true,
				...
				RecordId: {
					uId: "5d2bc4fd-dcd0-2e6a-d194-76812388ad13",
					name: "RecordId",
