define("MarketingEventQueueOp", ["terrasoft", "ext-base", "MarketingEventQueueOpResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.MarketingEventQueueOp", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.MarketingEventQueueOp",
			singleton: true,
			uId: "8317ab14-3d6b-2d94-6a88-059ac4efc228",
			name: "MarketingEventQueueOp",
			caption: resources.localizableStrings.MarketingEventQueueOpCaption,
		...
		return Terrasoft.MarketingEventQueueOp;
	});