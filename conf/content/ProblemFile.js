define("ProblemFile", ["terrasoft", "ext-base", "ProblemFileResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ProblemFile", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ProblemFile",
			singleton: true,
			uId: "b4227ab9-8e02-4cb3-a48e-65a2f2fd293a",
			name: "ProblemFile",
			caption: resources.localizableStrings.ProblemFileCaption,
			...
			columns: {
				...
				Problem: {
					uId: "4d42a5e0-b683-4b6b-8dbb-7c896cd950a6",
					name: "Problem",
