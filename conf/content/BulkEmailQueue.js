define("BulkEmailQueue", ["terrasoft", "ext-base", "BulkEmailQueueResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BulkEmailQueue", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BulkEmailQueue",
			singleton: true,
			uId: "7b585999-843e-4553-8674-74bba330a056",
			name: "BulkEmailQueue",
			caption: resources.localizableStrings.BulkEmailQueueCaption,
			...
			columns: {
				...
				BulkEmail: {
					uId: "e4fed44d-8142-4f6a-8d12-f3bbfb97d403",
					name: "BulkEmail",
				...
				EstimatedRowsCount: {
					uId: "c55cc1a2-8748-4b9f-87dd-b8e1211c95c0",
				...
				EstimatedTime: {
					uId: "3ca64954-3823-49e6-8c81-ec0c9540dd1c",
					name: "EstimatedTime",
		...
		return Terrasoft.BulkEmailQueue;
	});