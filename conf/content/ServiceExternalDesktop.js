Terrasoft.configuration.Structures["ServiceExternalDesktop"] = {innerHierarchyStack: ["ServiceExternalDesktop"], structureParent: "CentralAreaDesktopTemplate"};
define('ServiceExternalDesktopStructure', ['ServiceExternalDesktopResources'], function(resources) {return {schemaUId:'56f9fac4-b74f-4821-91a6-62ad095d0c77',schemaCaption: "External Desktop", parentSchemaName: "CentralAreaDesktopTemplate", packageName: "CrtCaseService", schemaName:'ServiceExternalDesktop',parentSchemaUId:'fbc98c89-0691-479c-bc25-59c11ac2365f',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
