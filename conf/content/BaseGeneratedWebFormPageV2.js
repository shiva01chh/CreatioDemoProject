Terrasoft.configuration.Structures["BaseGeneratedWebFormPageV2"] = {innerHierarchyStack: ["BaseGeneratedWebFormPageV2WebForm", "BaseGeneratedWebFormPageV2Campaigns", "BaseGeneratedWebFormPageV2"], structureParent: "BaseModulePageV2"};
define('BaseGeneratedWebFormPageV2WebFormStructure', ['BaseGeneratedWebFormPageV2WebFormResources'], function(resources) {return {schemaUId:'424d9da7-8f97-4524-8089-e64620d8b3fa',schemaCaption: "Edit page, landing", parentSchemaName: "BaseModulePageV2", packageName: "MarketingCampaign", schemaName:'BaseGeneratedWebFormPageV2WebForm',parentSchemaUId:'d62293c0-7f14-44b1-b547-735fb40499cd',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGeneratedWebFormPageV2CampaignsStructure', ['BaseGeneratedWebFormPageV2CampaignsResources'], function(resources) {return {schemaUId:'11a51998-b109-4113-bce3-36186b101ced',schemaCaption: "Edit page, landing", parentSchemaName: "BaseGeneratedWebFormPageV2WebForm", packageName: "MarketingCampaign", schemaName:'BaseGeneratedWebFormPageV2Campaigns',parentSchemaUId:'424d9da7-8f97-4524-8089-e64620d8b3fa',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGeneratedWebFormPageV2WebForm",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseGeneratedWebFormPageV2Structure', ['BaseGeneratedWebFormPageV2Resources'], function(resources) {return {schemaUId:'dc8a79a0-061e-4127-8043-85d902027df5',schemaCaption: "Edit page, landing", parentSchemaName: "BaseGeneratedWebFormPageV2Campaigns", packageName: "MarketingCampaign", schemaName:'BaseGeneratedWebFormPageV2',parentSchemaUId:'11a51998-b109-4113-bce3-36186b101ced',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseGeneratedWebFormPageV2Campaigns",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
...
define('BaseGeneratedWebFormPageV2CampaignsResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseGeneratedWebFormPageV2Campaigns", [],
	function() {
		return {
			entitySchemaName: "GeneratedWebForm",
			details: /**SCHEMA_DETAILS*/{
