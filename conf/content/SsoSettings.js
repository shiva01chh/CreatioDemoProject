Terrasoft.configuration.Structures["SsoSettings"] = {innerHierarchyStack: ["SsoSettings"], structureParent: "BaseGridSectionTemplate"};
define('SsoSettingsStructure', ['SsoSettingsResources'], function(resources) {return {schemaUId:'d5ceba03-bfe4-4012-931d-9da5be2bbc63',schemaCaption: "SSO settings page", parentSchemaName: "BaseGridSectionTemplate", packageName: "SsoSettings", schemaName:'SsoSettings',parentSchemaUId:'a5678241-e5e0-f691-b825-84b6039d5fa2',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
