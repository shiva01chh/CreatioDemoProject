Terrasoft.configuration.Structures["BaseCommunicationDetail"] = {innerHierarchyStack: ["BaseCommunicationDetailCrtNUI", "BaseCommunicationDetailSocialNetworkIntegration", "BaseCommunicationDetailTwitterIntegration", "BaseCommunicationDetailFacebookIntegration", "BaseCommunicationDetailCTIBase", "BaseCommunicationDetail"], structureParent: "BaseDetailV2"};
define('BaseCommunicationDetailCrtNUIStructure', ['BaseCommunicationDetailCrtNUIResources'], function(resources) {return {schemaUId:'ea5d6815-6645-4962-bde0-440932d31441',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseDetailV2", packageName: "LeadManagement", schemaName:'BaseCommunicationDetailCrtNUI',parentSchemaUId:'3052ff9d-521d-4a6d-ba92-04a2261e1ea8',extendParent:false,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailSocialNetworkIntegrationStructure', ['BaseCommunicationDetailSocialNetworkIntegrationResources'], function(resources) {return {schemaUId:'920b02ba-dd4a-477f-8af0-8a45425ddc76',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseCommunicationDetailCrtNUI", packageName: "LeadManagement", schemaName:'BaseCommunicationDetailSocialNetworkIntegration',parentSchemaUId:'ea5d6815-6645-4962-bde0-440932d31441',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseCommunicationDetailCrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailTwitterIntegrationStructure', ['BaseCommunicationDetailTwitterIntegrationResources'], function(resources) {return {schemaUId:'62df62b0-0f4e-4a31-8f58-5570a52dc509',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseCommunicationDetailSocialNetworkIntegration", packageName: "LeadManagement", schemaName:'BaseCommunicationDetailTwitterIntegration',parentSchemaUId:'920b02ba-dd4a-477f-8af0-8a45425ddc76',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseCommunicationDetailSocialNetworkIntegration",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailFacebookIntegrationStructure', ['BaseCommunicationDetailFacebookIntegrationResources'], function(resources) {return {schemaUId:'ab42a082-040d-4935-a695-42b27866f281',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseCommunicationDetailTwitterIntegration", packageName: "LeadManagement", schemaName:'BaseCommunicationDetailFacebookIntegration',parentSchemaUId:'62df62b0-0f4e-4a31-8f58-5570a52dc509',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseCommunicationDetailTwitterIntegration",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailCTIBaseStructure', ['BaseCommunicationDetailCTIBaseResources'], function(resources) {return {schemaUId:'0f26788d-e718-4db6-9355-8f17a94725b2',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseCommunicationDetailFacebookIntegration", packageName: "LeadManagement", schemaName:'BaseCommunicationDetailCTIBase',parentSchemaUId:'ab42a082-040d-4935-a695-42b27866f281',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseCommunicationDetailFacebookIntegration",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailStructure', ['BaseCommunicationDetailResources'], function(resources) {return {schemaUId:'b47b910d-0e27-4c8b-af95-2cd9b8425774',schemaCaption: "Base detail schema - Communication options", parentSchemaName: "BaseCommunicationDetailCTIBase", packageName: "LeadManagement", schemaName:'BaseCommunicationDetail',parentSchemaUId:'0f26788d-e718-4db6-9355-8f17a94725b2',extendParent:true,type:Terrasoft.SchemaType.GRID_DETAIL_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseCommunicationDetailCTIBase",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseCommunicationDetailCrtNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("BaseCommunicationDetailCrtNUI", ["BaseCommunicationDetailResources", "terrasoft", "ViewUtilities",
...
define('BaseCommunicationDetailCTIBaseResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseCommunicationDetailCTIBase", ["CTIBaseCommunicationViewModel"],
	function() {
		return {
			messages: {
				"CallCustomer": {
