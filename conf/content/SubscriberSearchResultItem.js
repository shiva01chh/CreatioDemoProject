...
define('SubscriberSearchResultItemStructure', ['SubscriberSearchResultItemResources'], function(resources) {return {schemaUId:'4619e417-2904-479a-9cfe-024854c40b99',schemaCaption: "Found subscriber schema", parentSchemaName: "", packageName: "CTIBase", schemaName:'SubscriberSearchResultItem',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
