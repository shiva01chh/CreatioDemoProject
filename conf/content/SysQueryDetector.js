define("SysQueryDetector", ["terrasoft", "ext-base", "SysQueryDetectorResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SysQueryDetector", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SysQueryDetector",
			singleton: true,
			uId: "63b874db-289b-4bd2-97b2-6391c737fc9e",
			...
			columns: {
				...
				Recommendation: {
					uId: "068aadcd-e834-7893-21d1-b6f381fc8576",
					name: "Recommendation",
		...
		return Terrasoft.SysQueryDetector;
	});