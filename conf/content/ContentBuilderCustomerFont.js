define("ContentBuilderCustomerFont", ["terrasoft", "ext-base", "ContentBuilderCustomerFontResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.ContentBuilderCustomerFont", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.ContentBuilderCustomerFont",
			singleton: true,
			uId: "5fc6c3ee-939c-485a-a4ff-7374219712fc",
			name: "ContentBuilderCustomerFont",
			caption: resources.localizableStrings.ContentBuilderCustomerFontCaption,
			...
			columns: {
				...
				Url: {
					uId: "3f1999c5-e649-41b3-bcd4-385fdd50695e",
					name: "Url",
		...
		return Terrasoft.ContentBuilderCustomerFont;
	});