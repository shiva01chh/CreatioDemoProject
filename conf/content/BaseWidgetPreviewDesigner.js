...
define('BaseWidgetPreviewDesignerStructure', ['BaseWidgetPreviewDesignerResources'], function(resources) {return {schemaUId:'cbe89c2d-78ba-4edf-9293-f13e4de50fea',schemaCaption: "Base widget preview designer", parentSchemaName: "", packageName: "CrtPlatform7x", schemaName:'BaseWidgetPreviewDesigner',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
