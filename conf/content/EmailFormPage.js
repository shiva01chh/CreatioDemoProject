Terrasoft.configuration.Structures["EmailFormPage"] = {innerHierarchyStack: ["EmailFormPage"], structureParent: "PageWithTabsFreedomTemplate"};
define('EmailFormPageStructure', ['EmailFormPageResources'], function(resources) {return {schemaUId:'4836cce5-14d8-43a8-86e2-f43f1ea3acff',schemaCaption: "Email Page", parentSchemaName: "PageWithTabsFreedomTemplate", packageName: "CrtUIv2", schemaName:'EmailFormPage',parentSchemaUId:'3b2e117f-8c6b-4ca5-80a2-7ebb497cddf9',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
