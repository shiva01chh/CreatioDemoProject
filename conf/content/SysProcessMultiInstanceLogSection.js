Terrasoft.configuration.Structures["SysProcessMultiInstanceLogSection"] = {innerHierarchyStack: ["SysProcessMultiInstanceLogSection"], structureParent: "SysProcessLogSectionV2"};
define('SysProcessMultiInstanceLogSectionStructure', ['SysProcessMultiInstanceLogSectionResources'], function(resources) {return {schemaUId:'3c1be924-934e-4ef5-8867-7e83f6d5b4e7',schemaCaption: "SysProcessMultiInstanceLogSection", parentSchemaName: "SysProcessLogSectionV2", packageName: "CrtUIv2", schemaName:'SysProcessMultiInstanceLogSection',parentSchemaUId:'4a7e35ba-cd9e-4f94-ac5d-4aa2f92d00b2',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
