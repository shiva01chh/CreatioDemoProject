Terrasoft.configuration.Structures["ReleasePage"] = {innerHierarchyStack: ["ReleasePage"], structureParent: "BaseModulePageV2"};
define('ReleasePageStructure', ['ReleasePageResources'], function(resources) {return {schemaUId:'8f977296-1e59-46d0-920a-805d779f9bc1',schemaCaption: "Edit page schema - \"Releases\" section", parentSchemaName: "BaseModulePageV2", packageName: "Release", schemaName:'ReleasePage',parentSchemaUId:'d62293c0-7f14-44b1-b547-735fb40499cd',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
