define("CampaignParticipantInfo", ["terrasoft", "ext-base", "CampaignParticipantInfoResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.CampaignParticipantInfo", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.CampaignParticipantInfo",
			singleton: true,
			uId: "19aa0bd2-80bc-406b-8ada-9a8acea053e8",
			name: "CampaignParticipantInfo",
			caption: resources.localizableStrings.CampaignParticipantInfoCaption,
		...
		return Terrasoft.CampaignParticipantInfo;
	});