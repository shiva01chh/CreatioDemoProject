Terrasoft.configuration.Structures["ProcessUserTaskActivityEditSchema"] = {innerHierarchyStack: ["ProcessUserTaskActivityEditSchemaCrtProcessDesigner", "ProcessUserTaskActivityEditSchema"]};
define('ProcessUserTaskActivityEditSchemaCrtProcessDesignerStructure', ['ProcessUserTaskActivityEditSchemaCrtProcessDesignerResources'], function(resources) {return {schemaUId:'b4cab600-0888-4965-99ca-5e90bf855bfa',schemaCaption: "ProcessUserTaskActivityEditSchema", parentSchemaName: "", packageName: "ProcessDesigner", schemaName:'ProcessUserTaskActivityEditSchemaCrtProcessDesigner',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ProcessUserTaskActivityEditSchemaStructure', ['ProcessUserTaskActivityEditSchemaResources'], function(resources) {return {schemaUId:'b66e10dc-66c6-434e-9f40-b65b3ecf71d9',schemaCaption: "ProcessUserTaskActivityEditSchema", parentSchemaName: "ProcessUserTaskActivityEditSchemaCrtProcessDesigner", packageName: "ProcessDesigner", schemaName:'ProcessUserTaskActivityEditSchema',parentSchemaUId:'b4cab600-0888-4965-99ca-5e90bf855bfa',extendParent:true,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"ProcessUserTaskActivityEditSchemaCrtProcessDesigner",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('ProcessUserTaskActivityEditSchemaCrtProcessDesignerResources', ['terrasoft'], function(Terrasoft) {
...
define("ProcessUserTaskActivityEditSchemaCrtProcessDesigner", ["ProcessUserTaskActivityEditSchemaResources",
