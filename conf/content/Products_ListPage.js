Terrasoft.configuration.Structures["Products_ListPage"] = {innerHierarchyStack: ["Products_ListPageCrtProductBase", "Products_ListPage"], structureParent: "ListFreedomTemplate"};
define('Products_ListPageCrtProductBaseStructure', ['Products_ListPageCrtProductBaseResources'], function(resources) {return {schemaUId:'052a774d-0eee-4e20-a6dd-650f63ddecc0',schemaCaption: "Products list page", parentSchemaName: "ListFreedomTemplate", packageName: "CrtProductCatalogue", schemaName:'Products_ListPageCrtProductBase',parentSchemaUId:'3f1f3f38-a0a4-4549-b895-249fb08f554a',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){

}};});
define('Products_ListPageStructure', ['Products_ListPageResources'], function(resources) {return {schemaUId:'cde09597-2a3d-410a-babd-56689bf7e826',schemaCaption: "Products list page", parentSchemaName: "Products_ListPageCrtProductBase", packageName: "CrtProductCatalogue", schemaName:'Products_ListPage',parentSchemaUId:'052a774d-0eee-4e20-a6dd-650f63ddecc0',extendParent:true,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:"Products_ListPageCrtProductBase",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){

}};});
define('Products_ListPageCrtProductBaseResources', ['terrasoft'], function(Terrasoft) {
...
define("Products_ListPageCrtProductBase", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
