define("SsoIdentityProvider", ["terrasoft", "ext-base", "SsoIdentityProviderResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.SsoIdentityProvider", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.SsoIdentityProvider",
			singleton: true,
			uId: "b335809f-b168-4952-ac9c-6aa10c05e897",
			...
			columns: {
				...
				Name: {
					uId: "10939200-1444-99ae-c147-354d05c27f81",
					name: "Name",
				...
				DisplayName: {
					uId: "a00ee82e-8681-942e-b7ab-8961df777bfb",
					name: "DisplayName",
				...
				SingleLogoutServiceUrl: {
					uId: "2d936135-27af-0727-65db-1a2f892278ee",
				...
				SingleSignOnServiceUrl: {
					uId: "3c1490b8-18c2-6bb7-c313-d7b942bfdb6c",
				...
				AdditionalParams: {
					uId: "b58447d6-d500-35c8-4ca9-9ef47a2ed413",
				...
				PartnerCertificateThumbprint: {
					uId: "f26d9f2f-568c-fe52-5f0a-0d23819fb737",
				...
				Type: {
					uId: "756c368f-a061-3329-82fa-3289282e4519",
					name: "Type",
					...
					isRequired: true,
					isLookup: true,
					referenceSchemaName: "SsoIdentityType",
					referenceSchema: {
		...
		return Terrasoft.SsoIdentityProvider;
	});