Terrasoft.configuration.Structures["BaseDataView"] = {innerHierarchyStack: ["BaseDataViewCrtNUI", "BaseDataViewCrtDeduplication", "BaseDataViewCrtESN7x", "BaseDataView"]};
define('BaseDataViewCrtNUIStructure', ['BaseDataViewCrtNUIResources'], function(resources) {return {schemaUId:'22e2cf10-98b4-4c3c-bc28-346238e15c21',schemaCaption: "Base data view", parentSchemaName: "", packageName: "SSP", schemaName:'BaseDataViewCrtNUI',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewCrtDeduplicationStructure', ['BaseDataViewCrtDeduplicationResources'], function(resources) {return {schemaUId:'75ca5755-d86b-4daa-8a57-3bc400658357',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewCrtNUI", packageName: "SSP", schemaName:'BaseDataViewCrtDeduplication',parentSchemaUId:'22e2cf10-98b4-4c3c-bc28-346238e15c21',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewCrtNUI",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewCrtESN7xStructure', ['BaseDataViewCrtESN7xResources'], function(resources) {return {schemaUId:'39e54205-fbb4-4945-a2c3-50768a0625a1',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewCrtDeduplication", packageName: "SSP", schemaName:'BaseDataViewCrtESN7x',parentSchemaUId:'75ca5755-d86b-4daa-8a57-3bc400658357',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewCrtDeduplication",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewStructure', ['BaseDataViewResources'], function(resources) {return {schemaUId:'6f8acb3b-5322-4111-abe6-dc16d62d334c',schemaCaption: "Base data view", parentSchemaName: "BaseDataViewCrtESN7x", packageName: "SSP", schemaName:'BaseDataView',parentSchemaUId:'39e54205-fbb4-4945-a2c3-50768a0625a1',extendParent:true,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:"BaseDataViewCrtESN7x",schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){

}};});
define('BaseDataViewCrtNUIResources', ['terrasoft'], function(Terrasoft) {
...
define("BaseDataViewCrtNUI", ["terrasoft", "ConfigurationEnums", "ConfigurationConstants", "RightUtilities",
...
define('BaseDataViewCrtDeduplicationResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseDataViewCrtDeduplication", ["RightUtilities", "DuplicatesSearchUtilitiesV2", "DuplicatesMergeHelper", "SectionMergeHelper"],
...
define('BaseDataViewCrtESN7xResources', ['terrasoft'], function(Terrasoft) {
var localizableStrings={
...
define("BaseDataViewCrtESN7x", ["ServiceHelper", "EsnSubscriptionMixin"], function(ServiceHelper) {
	return {
		messages: {
			/**
