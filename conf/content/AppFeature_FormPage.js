Terrasoft.configuration.Structures["AppFeature_FormPage"] = {innerHierarchyStack: ["AppFeature_FormPage"], structureParent: "PageWithLeftAreaTemplate"};
define('AppFeature_FormPageStructure', ['AppFeature_FormPageResources'], function(resources) {return {schemaUId:'1adae693-0f49-4423-a584-4fb81ba10786',schemaCaption: "AppFeature form page", parentSchemaName: "PageWithLeftAreaTemplate", packageName: "FeatureToggling", schemaName:'AppFeature_FormPage',parentSchemaUId:'0f8eb896-7b62-4dfa-bd55-a414f50932a7',extendParent:false,type:Terrasoft.SchemaType.ANGULAR_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},parameters:{},schemaDifferences:function(){
