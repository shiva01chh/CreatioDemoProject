Terrasoft.configuration.Structures["BulkEmailAudienceSection"] = {innerHierarchyStack: ["BulkEmailAudienceSection"], structureParent: "BaseManageAudienceSection"};
define('BulkEmailAudienceSectionStructure', ['BulkEmailAudienceSectionResources'], function(resources) {return {schemaUId:'b457ed8a-788c-62d3-9b1e-fc459862e39c',schemaCaption: "Section to manage bulk email audience", parentSchemaName: "BaseManageAudienceSection", packageName: "MarketingCampaign", schemaName:'BulkEmailAudienceSection',parentSchemaUId:'3f3e590a-d695-4b60-a585-24f7c571a320',extendParent:false,type:Terrasoft.SchemaType.MODULE_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
