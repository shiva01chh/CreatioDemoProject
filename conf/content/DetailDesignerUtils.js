Terrasoft.configuration.Structures["DetailDesignerUtils"] = {innerHierarchyStack: ["DetailDesignerUtils"]};
define('DetailDesignerUtilsStructure', ['DetailDesignerUtilsResources'], function(resources) {return {schemaUId:'cf15aeb0-710a-44ea-b2b9-f61870e7cd2c',schemaCaption: "Detail  designer utility module", parentSchemaName: "", packageName: "CrtDesignerTools", schemaName:'DetailDesignerUtils',parentSchemaUId:'',extendParent:false,type:Terrasoft.SchemaType.EDIT_VIEW_MODEL_SCHEMA,entitySchema:'',name:'',extend:'Terrasoft.model.BaseViewModel',schema:{leftPanel:[],rightPanel:[],actions:[],analytics:[]},methods:{},controlsConfig:{},customBindings:{},bindings:{},schemaDifferences:function(){
