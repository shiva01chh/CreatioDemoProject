define("BETArchiveSecondGeneration", ["terrasoft", "ext-base", "BETArchiveSecondGenerationResources"],
	function(Terrasoft, Ext, resources) {
		Ext.define("Terrasoft.data.models.BETArchiveSecondGeneration", {
			extend: "Terrasoft.BaseEntitySchema",
			alternateClassName: "Terrasoft.BETArchiveSecondGeneration",
			singleton: true,
			uId: "e2b493b1-f941-bde6-ab76-a91a22d2dbfd",
			name: "BETArchiveSecondGeneration",
			caption: resources.localizableStrings.BETArchiveSecondGenerationCaption,
		...
		return Terrasoft.BETArchiveSecondGeneration;
	});