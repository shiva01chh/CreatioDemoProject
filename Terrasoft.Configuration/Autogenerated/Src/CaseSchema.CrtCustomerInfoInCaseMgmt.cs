namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CaseSchema : Terrasoft.Configuration.Case_CrtCaseManagementApp_TerrasoftSchema
	{
	...
	/// Case.
	/// </summary>
	public class Case : Terrasoft.Configuration.Case_CrtCaseManagementApp_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Case_CrtCustomerInfoInCaseMgmtEventsProcess<TEntity> : Terrasoft.Configuration.Case_CrtCaseManagementAppEventsProcess<TEntity> where TEntity : Case
	{
	...
	/// <exclude/>
	public class Case_CrtCustomerInfoInCaseMgmtEventsProcess : Case_CrtCustomerInfoInCaseMgmtEventsProcess<Case>
	{
	...
	/// <exclude/>
	public class CaseEventsProcess : Case_CrtCustomerInfoInCaseMgmtEventsProcess
	{
