namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class BulkEmailFolder_MarketingCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtBaseEventsProcess<TEntity> where TEntity : BulkEmailFolder
	{
