namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class PartnershipFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public PartnershipFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "PartnershipFolder";
		...
		public PartnershipFolder Parent {
			get {
				return _parent ??
					(_parent = new PartnershipFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
