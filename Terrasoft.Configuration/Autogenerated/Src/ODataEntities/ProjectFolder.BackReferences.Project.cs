namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProjectFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ProjectFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProjectFolder";
		...
		public ProjectFolder Parent {
			get {
				return _parent ??
					(_parent = new ProjectFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
