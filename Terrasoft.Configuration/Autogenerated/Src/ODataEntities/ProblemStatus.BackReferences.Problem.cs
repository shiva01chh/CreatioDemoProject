namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProblemStatus : Terrasoft.Core.Entities.Entity
	{
		...
		public ProblemStatus(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProblemStatus";
		...
		public IEnumerable<Problem> ProblemCollectionByStatus {
			get;
			set;
		}
