namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ReleaseTeam : Terrasoft.Core.Entities.Entity
	{
		...
		public ReleaseTeam(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ReleaseTeam";
		...
		public SysAdminUnit Responsible {
			get {
				return _responsible ??
					(_responsible = new SysAdminUnit(LookupColumnEntities.GetEntity("Responsible")));
			}
		}
