namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class InvoiceFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public InvoiceFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "InvoiceFolder";
		...
		public InvoiceFolder Parent {
			get {
				return _parent ??
					(_parent = new InvoiceFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
