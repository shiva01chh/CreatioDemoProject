namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProblemFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ProblemFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProblemFolder";
		...
		public IEnumerable<ProblemFolder> ProblemFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<ProblemInFolder> ProblemInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public ProblemFolder Parent {
			get {
				return _parent ??
					(_parent = new ProblemFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
