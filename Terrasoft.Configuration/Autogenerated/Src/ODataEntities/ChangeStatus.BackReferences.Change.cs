namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ChangeStatus : Terrasoft.Core.Entities.Entity
	{
		...
		public ChangeStatus(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ChangeStatus";
		...
		public IEnumerable<Change> ChangeCollectionByStatus {
			get;
			set;
		}
