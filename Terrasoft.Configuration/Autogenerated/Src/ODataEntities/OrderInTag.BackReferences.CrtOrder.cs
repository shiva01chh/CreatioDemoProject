namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OrderInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public OrderInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OrderInTag";
		...
		public OrderTag Tag {
			get {
				return _tag ??
					(_tag = new OrderTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Order Entity {
			get {
				return _entity ??
					(_entity = new Order(LookupColumnEntities.GetEntity("Entity")));
			}
		}
