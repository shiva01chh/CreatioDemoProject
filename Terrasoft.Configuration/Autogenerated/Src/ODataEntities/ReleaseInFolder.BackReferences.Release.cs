namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ReleaseInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ReleaseInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ReleaseInFolder";
		...
		private ReleaseFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public ReleaseFolder Folder {
			get {
				return _folder ??
					(_folder = new ReleaseFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
