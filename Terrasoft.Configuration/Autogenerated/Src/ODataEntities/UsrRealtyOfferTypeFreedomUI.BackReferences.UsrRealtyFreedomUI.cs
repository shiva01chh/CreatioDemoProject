namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class UsrRealtyOfferTypeFreedomUI : Terrasoft.Core.Entities.Entity
	{
		...
		public UsrRealtyOfferTypeFreedomUI(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "UsrRealtyOfferTypeFreedomUI";
		...
		public IEnumerable<UsrRealtyFreedomUI> UsrRealtyFreedomUICollectionByUsrOfferType {
			get;
			set;
		}
