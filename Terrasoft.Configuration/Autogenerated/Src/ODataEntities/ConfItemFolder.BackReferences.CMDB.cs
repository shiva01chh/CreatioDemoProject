namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ConfItemFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ConfItemFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ConfItemFolder";
		...
		public IEnumerable<ConfItemFolder> ConfItemFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<ConfItemInFolder> ConfItemInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public ConfItemFolder Parent {
			get {
				return _parent ??
					(_parent = new ConfItemFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
