namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ConfigItemStatus : Terrasoft.Core.Entities.Entity
	{
		...
		public ConfigItemStatus(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ConfigItemStatus";
		...
		public IEnumerable<ConfItem> ConfItemCollectionByStatus {
			get;
			set;
		}
