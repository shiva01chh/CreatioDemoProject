namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProblemPriority : Terrasoft.Core.Entities.Entity
	{
		...
		public ProblemPriority(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProblemPriority";
		...
		public IEnumerable<Problem> ProblemCollectionByPriority {
			get;
			set;
		}
