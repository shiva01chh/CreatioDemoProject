namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class UsrRealtyClassicFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public UsrRealtyClassicFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "UsrRealtyClassicFolder";
		...
		public IEnumerable<UsrRealtyClassicFolder> UsrRealtyClassicFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<UsrRealtyClassicInFolder> UsrRealtyClassicInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public UsrRealtyClassicFolder Parent {
			get {
				return _parent ??
					(_parent = new UsrRealtyClassicFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
