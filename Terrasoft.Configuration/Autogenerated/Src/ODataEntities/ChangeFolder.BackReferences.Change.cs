namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ChangeFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ChangeFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ChangeFolder";
		...
		public IEnumerable<ChangeFolder> ChangeFolderCollectionByParent {
			get;
			set;
		}

		public IEnumerable<ChangeInFolder> ChangeInFolderCollectionByFolder {
			get;
			set;
		}
		...
		public ChangeFolder Parent {
			get {
				return _parent ??
					(_parent = new ChangeFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
