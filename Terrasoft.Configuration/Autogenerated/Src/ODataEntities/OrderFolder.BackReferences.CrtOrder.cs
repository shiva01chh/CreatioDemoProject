namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OrderFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OrderFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OrderFolder";
		...
		public OrderFolder Parent {
			get {
				return _parent ??
					(_parent = new OrderFolder(LookupColumnEntities.GetEntity("Parent")));
			}
		}
