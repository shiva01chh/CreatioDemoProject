namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class OrderInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public OrderInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "OrderInFolder";
		...
		private OrderFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public OrderFolder Folder {
			get {
				return _folder ??
					(_folder = new OrderFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
