namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProblemInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ProblemInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProblemInTag";
		...
		public ProblemTag Tag {
			get {
				return _tag ??
					(_tag = new ProblemTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		private Problem _entity;
		/// <summary>
		/// Object.
		/// </summary>
		public Problem Entity {
			get {
				return _entity ??
					(_entity = new Problem(LookupColumnEntities.GetEntity("Entity")));
			}
		}
