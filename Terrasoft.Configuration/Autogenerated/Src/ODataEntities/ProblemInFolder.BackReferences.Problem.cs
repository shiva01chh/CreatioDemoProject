namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProblemInFolder : Terrasoft.Core.Entities.Entity
	{
		...
		public ProblemInFolder(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProblemInFolder";
		...
		private ProblemFolder _folder;
		/// <summary>
		/// Folder.
		/// </summary>
		public ProblemFolder Folder {
			get {
				return _folder ??
					(_folder = new ProblemFolder(LookupColumnEntities.GetEntity("Folder")));
			}
		}
