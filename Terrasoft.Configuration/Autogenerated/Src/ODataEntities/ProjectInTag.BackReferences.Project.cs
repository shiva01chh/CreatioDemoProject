namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProjectInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ProjectInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProjectInTag";
		...
		public ProjectTag Tag {
			get {
				return _tag ??
					(_tag = new ProjectTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		public Project Entity {
			get {
				return _entity ??
					(_entity = new Project(LookupColumnEntities.GetEntity("Entity")));
			}
		}
