namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ProjectPlanHistoryItem : Terrasoft.Core.Entities.Entity
	{
		...
		public ProjectPlanHistoryItem(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ProjectPlanHistoryItem";
		...
		public ProjectRole Role {
			get {
				return _role ??
					(_role = new ProjectRole(LookupColumnEntities.GetEntity("Role")));
			}
		}
