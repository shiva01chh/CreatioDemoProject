namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ReleaseInTag : Terrasoft.Core.Entities.Entity
	{
		...
		public ReleaseInTag(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ReleaseInTag";
		...
		public ReleaseTag Tag {
			get {
				return _tag ??
					(_tag = new ReleaseTag(LookupColumnEntities.GetEntity("Tag")));
			}
		}
		...
		private Release _entity;
		/// <summary>
		/// Object.
		/// </summary>
		public Release Entity {
			get {
				return _entity ??
					(_entity = new Release(LookupColumnEntities.GetEntity("Entity")));
			}
		}
