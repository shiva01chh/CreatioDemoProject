namespace Terrasoft.Configuration.OData
{
	...
	/// <exclude/>
	public class ConfigItemModel : Terrasoft.Core.Entities.Entity
	{
		...
		public ConfigItemModel(Terrasoft.Core.Entities.Entity source)
			: base(source) {
			SchemaName = "ConfigItemModel";
		...
		public IEnumerable<ConfItem> ConfItemCollectionByModel {
			get;
			set;
		}
		...
		public ConfigItemType ConfItemType {
			get {
				return _confItemType ??
					(_confItemType = new ConfigItemType(LookupColumnEntities.GetEntity("ConfItemType")));
			}
		}
