namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class InformationSource_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : InformationSource
	{
