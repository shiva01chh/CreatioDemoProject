namespace Terrasoft.Configuration
{
	...
	public class SysSettingsFolderSchema : Terrasoft.Configuration.BaseFolderSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new SysSettingsFolder_CrtBaseEventsProcess(userConnection);
		}
	...
	public class SysSettingsFolder : Terrasoft.Configuration.BaseFolder
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new SysSettingsFolder_CrtBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: SysSettingsFolder_CrtBaseEventsProcess

	/// <exclude/>
	public partial class SysSettingsFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtBaseEventsProcess<TEntity> where TEntity : SysSettingsFolder
	{

		public SysSettingsFolder_CrtBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "SysSettingsFolder_CrtBaseEventsProcess";
	...
	/// <exclude/>
	public class SysSettingsFolder_CrtBaseEventsProcess : SysSettingsFolder_CrtBaseEventsProcess<SysSettingsFolder>
	{
	...
	public partial class SysSettingsFolder_CrtBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class SysSettingsFolderEventsProcess : SysSettingsFolder_CrtBaseEventsProcess
	{
