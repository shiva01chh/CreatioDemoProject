namespace Terrasoft.Configuration
{
	...
	public class DepartmentSchema : Terrasoft.Configuration.BaseLookupSchema
	{
		...
		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Department_CrtBaseEventsProcess(userConnection);
		}
	...
	public class Department : Terrasoft.Configuration.BaseLookup
	{
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Department_CrtBaseEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
	...
	#region Class: Department_CrtBaseEventsProcess

	/// <exclude/>
	public partial class Department_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : Department
	{

		public Department_CrtBaseEventsProcess(UserConnection userConnection)
			: base(userConnection) {
			InitializeMetaPathParameterValues();
			UId = Guid.NewGuid();
			Name = "Department_CrtBaseEventsProcess";
	...
	/// <exclude/>
	public class Department_CrtBaseEventsProcess : Department_CrtBaseEventsProcess<Department>
	{
	...
	public partial class Department_CrtBaseEventsProcess<TEntity>
	{
	...
	/// <exclude/>
	public class DepartmentEventsProcess : Department_CrtBaseEventsProcess
	{
