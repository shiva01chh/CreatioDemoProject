namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CmpgnParticipantStatus_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : CmpgnParticipantStatus
	{
