namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServiceType_CrtSLMEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : ServiceType
	{
