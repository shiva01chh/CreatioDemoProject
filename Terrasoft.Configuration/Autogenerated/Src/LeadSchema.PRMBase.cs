namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Lead_PRMBase_TerrasoftSchema : Terrasoft.Configuration.Lead_CrtOrderLead_TerrasoftSchema
	{
	...
	/// Lead.
	/// </summary>
	public class Lead_PRMBase_Terrasoft : Terrasoft.Configuration.Lead_CrtOrderLead_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Lead_PRMBaseEventsProcess<TEntity> : Terrasoft.Configuration.Lead_CrtOrderLeadEventsProcess<TEntity> where TEntity : Lead_PRMBase_Terrasoft
	{
