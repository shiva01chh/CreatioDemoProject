namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityCloseReason_CrtOpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : OpportunityCloseReason
	{
