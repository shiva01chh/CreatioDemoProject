namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class OpportunityCreateReason_OpportunityEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : OpportunityCreateReason
	{
