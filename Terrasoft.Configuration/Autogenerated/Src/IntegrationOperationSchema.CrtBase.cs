namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class IntegrationOperation_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseCodeLookup_CrtBaseEventsProcess<TEntity> where TEntity : IntegrationOperation
	{
