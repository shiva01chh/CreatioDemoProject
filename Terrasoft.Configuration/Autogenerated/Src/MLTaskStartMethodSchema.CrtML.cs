namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class MLTaskStartMethod_CrtMLEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : MLTaskStartMethod
	{
