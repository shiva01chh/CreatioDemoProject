namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class Case_SLMITILService_TerrasoftSchema : Terrasoft.Configuration.Case_CMDB_TerrasoftSchema
	{
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("4c62a769-1e29-4b01-b8ce-15ee21596350");
		...
		protected override EntitySchemaColumn CreateSupportLevelColumn() {
			EntitySchemaColumn column = base.CreateSupportLevelColumn();
			column.ModifiedInSchemaUId = new Guid("4c62a769-1e29-4b01-b8ce-15ee21596350");
			return column;
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("4c62a769-1e29-4b01-b8ce-15ee21596350"));
		}
	...
	/// Case.
	/// </summary>
	public class Case_SLMITILService_Terrasoft : Terrasoft.Configuration.Case_CMDB_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Case_SLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.Case_CMDBEventsProcess<TEntity> where TEntity : Case_SLMITILService_Terrasoft
	{
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("4c62a769-1e29-4b01-b8ce-15ee21596350");
			}
		}
