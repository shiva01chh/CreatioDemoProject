namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class DistributionType_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : DistributionType
	{
