namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class AccountFolder_CrtBaseEventsProcess<TEntity> : Terrasoft.Configuration.BaseFolder_CrtBaseEventsProcess<TEntity> where TEntity : AccountFolder
	{
	...
	/// <exclude/>
	public class AccountFolder_CrtBaseEventsProcess : AccountFolder_CrtBaseEventsProcess<AccountFolder>
	{
	...
	/// <exclude/>
	public class AccountFolderEventsProcess : AccountFolder_CrtBaseEventsProcess
	{
