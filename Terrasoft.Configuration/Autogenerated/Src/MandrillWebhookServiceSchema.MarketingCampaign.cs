namespace Terrasoft.Configuration
{
	...
	public class MandrillWebhookServiceSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			ZipBody = new byte[] { 31,139,8,0,0,0,0,0,0,3,203,75,204,77,45,46,72,76,78,85,8,73,45,42,74,44,206,79,43,209,115,206,207,75,203,76,47,45,74,44,201,204,207,211,243,77,204,75,41,202,204,201,9,78,45,42,203,76,78,229,229,170,230,229,170,229,229,226,229,2,2,0,142,106,233,123,62,0,0,0 };
		}
