namespace Terrasoft.Configuration
{
	...
	public class Activity_PRMPortal_TerrasoftSchema : Terrasoft.Configuration.Activity_MarketingCampaign_TerrasoftSchema
	{
		...
		public Activity_PRMPortal_TerrasoftSchema(EntitySchemaManager entitySchemaManager)
			: base(entitySchemaManager) {
		}

		public Activity_PRMPortal_TerrasoftSchema(Activity_PRMPortal_TerrasoftSchema source, bool isShallowClone)
			: base(source, isShallowClone) {
		}

		public Activity_PRMPortal_TerrasoftSchema(Activity_PRMPortal_TerrasoftSchema source)
			: base(source) {
		}
		...
		protected override void InitializeProperties() {
			...
			RealUId = new Guid("269544e7-348f-439b-80ad-51e8fd965c2c");
			Name = "Activity_PRMPortal_Terrasoft";
		...
		public override Entity CreateEntity(UserConnection userConnection) {
			return new Activity_PRMPortal_Terrasoft(userConnection) {Schema = this};
		}

		public override EmbeddedProcess CreateEventsProcess(UserConnection userConnection) {
			return new Activity_PRMPortalEventsProcess(userConnection);
		}

		public override object Clone() {
			return new Activity_PRMPortal_TerrasoftSchema(this);
		}

		public override EntitySchema CloneShallow() {
			return new Activity_PRMPortal_TerrasoftSchema(this, true);
		}

		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			base.GetParentRealUIds(realUIds);
			realUIds.Add(new Guid("269544e7-348f-439b-80ad-51e8fd965c2c"));
		}
	...
	#region Class: Activity_PRMPortal_Terrasoft
	...
	public class Activity_PRMPortal_Terrasoft : Terrasoft.Configuration.Activity_MarketingCampaign_Terrasoft
	{
		...
		public Activity_PRMPortal_Terrasoft(UserConnection userConnection)
			: base(userConnection) {
			SchemaName = "Activity_PRMPortal_Terrasoft";
		}

		public Activity_PRMPortal_Terrasoft(Activity_PRMPortal_Terrasoft source)
			: base(source) {
		}
		...
		protected override Process InitializeEmbeddedProcess() {
			var process = new Activity_PRMPortalEventsProcess(UserConnection);
			process.Entity = this;
			return process;
		}
		...
		public override object Clone() {
			return new Activity_PRMPortal_Terrasoft(this);
		}
	...
	public partial class Activity_PRMPortalEventsProcess<TEntity> : Terrasoft.Configuration.Activity_MarketingCampaignEventsProcess<TEntity> where TEntity : Activity_PRMPortal_Terrasoft
	{
		...
		public Activity_PRMPortalEventsProcess(UserConnection userConnection)
			...
			UId = Guid.NewGuid();
			Name = "Activity_PRMPortalEventsProcess";
		...
		private Guid InternalSchemaUId {
			get {
				return new Guid("269544e7-348f-439b-80ad-51e8fd965c2c");
			}
		}
	...
	/// <exclude/>
	public class Activity_PRMPortalEventsProcess : Activity_PRMPortalEventsProcess<Activity_PRMPortal_Terrasoft>
	{
	...
	public partial class Activity_PRMPortalEventsProcess<TEntity>
	{
