namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class CampaignPeriodTime_CrtCampaignEventsProcess<TEntity> : Terrasoft.Configuration.BaseLookup_CrtBaseEventsProcess<TEntity> where TEntity : CampaignPeriodTime
	{
