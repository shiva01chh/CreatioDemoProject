namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class CountrySchema : Terrasoft.Configuration.Country_CrtBase_TerrasoftSchema
	{
	...
	/// Country.
	/// </summary>
	public class Country : Terrasoft.Configuration.Country_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class Country_SSPEventsProcess<TEntity> : Terrasoft.Configuration.Country_CrtBaseEventsProcess<TEntity> where TEntity : Country
	{
