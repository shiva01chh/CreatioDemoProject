namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public class AccountAddressSchema : Terrasoft.Configuration.AccountAddress_CrtBase_TerrasoftSchema
	{
	...
	/// Account address.
	/// </summary>
	public class AccountAddress : Terrasoft.Configuration.AccountAddress_CrtBase_Terrasoft
	{
	...
	/// <exclude/>
	public partial class AccountAddress_CrtCustomer360AppEventsProcess<TEntity> : Terrasoft.Configuration.AccountAddress_CrtBaseEventsProcess<TEntity> where TEntity : AccountAddress
	{
	...
	/// <exclude/>
	public class AccountAddress_CrtCustomer360AppEventsProcess : AccountAddress_CrtCustomer360AppEventsProcess<AccountAddress>
	{
	...
	/// <exclude/>
	public class AccountAddressEventsProcess : AccountAddress_CrtCustomer360AppEventsProcess
	{
