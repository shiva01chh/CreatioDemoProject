namespace Terrasoft.Configuration
{
	...
	/// <exclude/>
	public partial class ServicePactInTag_CrtSLMITILServiceEventsProcess<TEntity> : Terrasoft.Configuration.BaseEntityInTag_CrtBaseEventsProcess<TEntity> where TEntity : ServicePactInTag
	{
